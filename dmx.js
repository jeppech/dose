...
const DMX_FREQUENCY = 30
const DMX_STEP_MS = 1000 / DMX_FREQUENCY

const dmx = new DMX()
// const dmx_driver = new EnttecOpenUSBDMXDriver('/dev/tty.usbserial-B001AUFL')
const universe = dmx.addUniverse("dmx-js", "enttec-open-usb-dmx", '/dev/tty.usbserial-B001AUFL')
...
const tilt_home = 255
const tilt_home_invert = 255 - tilt_home
// movinghead 1 addr = 1

const mh1_init = { 1: brightness, 2: 255, 3: 107, 4: tilt_home, 6: 100, 7: 40, 8: 1, 9: 207, 10: 30, 11: 190 }
const mh2_init = { 15: brightness, 16: 255, 17: 147, 18: tilt_home_invert, 20: 100, 21: 40, 22: 1, 23: 207, 24: 30, 25: 190 }
...
// setInterval(() => {
//   const random_pan = min_max(0, 255)
